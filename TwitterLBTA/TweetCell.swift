...
class TweetCell: DatasourceCell {
    ...
    let messageTextView: UITextView = {
        let tv = UITextView()
        tv.text = "sample message text view text"
    ...
    let profileImageView: UIImageView = {
        ...
        imageView.image = #imageLiteral(resourceName: "kralPhoto")
    ...
    let direcMessageButton: UIButton = {
        let button = UIButton(type: .system)
    ...
    fileprivate func setupBottomButtons() {
        ...
        direcMessageButton.anchor(directMessageButtonContainerView.topAnchor, left: directMessageButtonContainerView.leftAnchor, bottom: directMessageButtonContainerView.bottomAnchor, right: nil, topConstant: 0, leftConstant: 0, bottomConstant: 0, rightConstant: 0, widthConstant: 20, heightConstant: 20)
    }
